...
setup(
    ...
    install_requires=[
        "bleach==4.1.0; python_version >= '2.7' and python_version not in '3.0, 3.1, 3.2, 3.3, 3.4'",
        "certifi==2021.10.8",
        "chardet==4.0.0",
        "elementpath==2.4.0",
        "fints==3.0.1",
        ...
        "pyparsing==3.0.7; python_version >= '2.6' and python_version not in '3.0, 3.1, 3.2, 3.3'",
